    ...
    <div class="modal">
      ...
      <div class="modal-body">
        ...
        <div class="info-grid">
          ...
          <div class="info-cell"><div class="k">Poké Ball</div><div class="v" style="display:flex; align-items:center; gap:6px;">${p.ball ? `${ballIconHTML(effectiveBallName(p),26)}${escapeHTML(effectiveBallName(p))}` : '-'}</div></div>
